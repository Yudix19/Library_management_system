	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  		<h3 class="center-block" style="font-size:30px; font-style: italic; color:orangered;">Published Announcements</h3>
			</div>
		  </div>
		  <table class="table table-bordered">
      		...
      		<thead>
                <tr style="background-image:linear-gradient(135deg,black,grey);color: white; text-align: center; font-size: 18px;">
                    <th>NewsId</th>
                         <th>Announcement</th>
     ...
     <?php }
           ?>
			...
			<div class="panel panel-default">
				  <div class="panel-heading">
				    <h2 class="panel-title center-block"style="background-image:linear-gradient(135deg,black,grey);color: white; text-align: center; font-size: 18px; width: 50%; padding:10px 15px; border-radius:15px;">Publish New Announcements</h2>
				  </div>
