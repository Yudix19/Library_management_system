...
<div class="container">
    ...
    <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 20px">
        <div class="jumbotron login2 col-lg-10 col-md-11 col-sm-12 col-xs-12">
            ...
            <p class="page-header" style="text-align: center; background-image:linear-gradient(135deg,grey,black);padding-top: 5px; color: yellow;border-radius: 10px;">ADD BOOK</p>
                ...
                <form class="form-horizontal" role="form" enctype="multipart/form-data" action="addbook.php" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button  name="submit" class="btn btn-info col-lg-12" data-toggle="modal" data-target="#info" style="background-color:green; width: 100px; padding:10px 15px; margin-left: 50px;"> 
                                ADD BOOK
                            </button>

                            <input type="reset" name="reset" style=" background-color:green; width: 100px; padding:10px 15px; margin-left: 50px; font-size:16px; border-radius:15px; color:white; border:none;">
